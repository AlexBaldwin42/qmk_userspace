...
// Scylla: 58 keys (4x6 + 5 thumbs per side)
// Top number row + outer columns added around the shared 36-key core
//
// ╭──────────────────────────────────────╮ ╭──────────────────────────────────────╮
// │ num row (6 keys)                     │ │                     num row (6 keys) │
// │ outer │ 5-key core row 1       │     │ │     │ 5-key core row 1       │ outer │
// │ outer │ 5-key core row 2 (HRM) │     │ │     │ 5-key core row 2 (HRM) │ outer │
// │ outer │ 5-key core row 3       │     │ │     │ 5-key core row 3       │ outer │
// ╰───────────────╮ 5 thumb keys        │ │ 5 thumb keys  ╭───────────────────────╯
//                 ╰──────────────────────╯ ╰───────────────╯
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_BASE] = LAYOUT_split_4x6_5(
        ...
        KC_LSFT, LCTL_T(KC_Z), KC_X, KC_C, KC_V, KC_B,             KC_N,    KC_M, KC_COMM,  KC_DOT, ADJ_SLSH, KC_ENT,
                           LW_BSPC, RAI_DEL, KC_LALT,               KC_RALT, RAI_ENT, LW_SPC,
                                    NUM_TAB, KC_LGUI,                KC_RGUI, NUM_ESC
    ),

    [LAYER_POINTER] = LAYOUT_split_4x6_5(
        ...
        _______, _______, _______, _______, _______, _______,        _______, SNIPING_TOGGLE,_______, _______, _______, _______,
                          _______, MS_BTN1, _______,                 _______, _______, _______,
                                   MS_BTN2, _______,                 _______, _______
    ),
    ...
    [LAYER_ADJUST] = LAYOUT_split_4x6_5(
        _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______,
    ...
    [LAYER_NUMPAD] = LAYOUT_split_4x6_5(
        _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______,
